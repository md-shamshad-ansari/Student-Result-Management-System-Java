...
public class insertNewResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 350, 110, 40));
        ...
        insertNewStudent.setForeground(new java.awt.Color(255, 0, 0));
        insertNewStudent.setIcon(new javax.swing.ImageIcon(getClass().getResource("/student/result/management/system/image_processing20220801-17461-itiohr.png"))); // NOI18N
        ...
        jPanel1.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(41, 430, -1, 60));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
       ...
       if( rollno.length()==0 || physics.length()==0 || chemisty.length()==0 || mathematics.length()==0 || dbms.length()==0 || humanities.length()==0 )
           JOptionPane.showMessageDialog(null, "Enter all the details Correctly");
            ...
            try {
                 ...
                 if(rs.next()){
                     st.executeUpdate("insert into result values('"+rollno+"','"+physics+"','"+chemisty+"', '"+mathematics+"', '"+dbms+"','"+humanities+"')");
